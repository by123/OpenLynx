...
const D: Record<string, Entry> = {
  ...
  "help.scope.dt": { en: "Project / All projects", zh: "本项目 / 全部项目" },
  "help.scope.dd": {
    en: "Switch memory scope at the top. Project shows only this project; All projects shows every project on this machine.",
    zh: "顶部切换记忆范围。本项目只看当前项目；全部项目看本机所有项目。",
  },
